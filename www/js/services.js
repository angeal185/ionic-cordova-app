...
.service('BookMarkService', function (_, $rootScope){
	...
	this.bookmarkFeedPost = function(bookmark_post){
		...
		var user_bookmarks = !_.isUndefined(window.localStorage.mobileapp_feed_bookmarks) ?
														JSON.parse(window.localStorage.mobileapp_feed_bookmarks) : [];
		...
		window.localStorage.mobileapp_feed_bookmarks = JSON.stringify(user_bookmarks);
		$rootScope.$broadcast("new-bookmark");
	};

	this.bookmarkWordpressPost = function(bookmark_post){

		var user_bookmarks = !_.isUndefined(window.localStorage.mobileapp_wordpress_bookmarks) ?
														JSON.parse(window.localStorage.mobileapp_wordpress_bookmarks) : [];
		...
		window.localStorage.mobileapp_wordpress_bookmarks = JSON.stringify(user_bookmarks);
		$rootScope.$broadcast("new-bookmark");
	};

	this.getBookmarks = function(){
		return {
			feeds : JSON.parse(window.localStorage.mobileapp_feed_bookmarks || '[]'),
			wordpress: JSON.parse(window.localStorage.mobileapp_wordpress_bookmarks || '[]')
		};
	};
})
